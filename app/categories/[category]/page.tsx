...
const tools: Tool[] = [
  ...
  { id: "chat-pdf", name: "Chat with PDF", description: "Ask questions, get answers, and extract facts from PDF.", category: "ai", icon: <MessageSquare size={20} />, href: "/tools/chat-pdf" },
  { id: "summarize-pdf", name: "PDF Summarizer", description: "Generate structured bullet point summaries of long PDFs.", category: "ai", icon: <FileText size={20} />, href: "/tools/summarize-pdf" },
  { id: "translate-pdf", name: "PDF Translator", description: "Translate page layouts and texts to other languages.", category: "ai", icon: <Languages size={20} />, href: "/tools/translate-pdf" },
  { id: "review-pdf", name: "AI Contract Review", description: "Scan legal documents to detect risk clauses and warnings.", category: "ai", icon: <ShieldCheck size={20} />, href: "/tools/review-pdf" },
